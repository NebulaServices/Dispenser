...
import {ButtonInteraction, ButtonBuilder, Message, ButtonStyle} from "discord.js";
import DB from "../classes/DB";

export default class extends Button {
    override build(args: string[]): ButtonBuilder {
        return new ButtonBuilder().setLabel('dispense').setStyle(ButtonStyle.Primary).setCustomId(this.id())
